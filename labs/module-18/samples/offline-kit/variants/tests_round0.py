...
OFFLINE-KIT VARIANT: round 0. Two seeded defects for the Module 18 lab:
  * test_cancel_creates_refund is missing its @pytest.mark.ac decorator  → G3 markers_present FAIL
  * test_cancel_shipped_order_rejected reads body["errorCode"]           → G4 TEST_DEFECT
"""
...
def test_cancel_shipped_order_rejected(api, customer_a, make_order):
    ...
    assert response.json()["errorCode"] == "ORDER_NOT_CANCELLABLE"
